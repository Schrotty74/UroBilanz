...
assert.match(webCoreSource, /const APP_VERSION = "1\.7\.3"/, "Zentrale Web-App-Version fehlt");
...
assert.match(firstStartPromptSource, /opened UroBilanz for the first time/, "Englischer Erststart-Prompt fehlt");
