...
private let translations: [AppLanguage: [String: String]] = [
    .de: [
        ...
        "cancel": "Abbrechen", "entry_delete_confirm": "Diesen Eintrag wirklich löschen? Er wird aus Auswertung und Export entfernt.", "entries_day": "Einträge an diesem Messtag",
        "no_entries_day": "Für diesen Messtag gibt es noch keine Einträge.", "edit": "Bearbeiten", "all_years": "Alle Jahre",
        "all_months": "Alle Monate", "all_types": "Alle Typen", "filter_entries": "Einträge filtern", "search_entries": "Einträge durchsuchen", "clear_filters": "Filter zurücksetzen", "measurement_days": "Messtage", "urine_total": "Urin gesamt ml", "urine_average": "Urin Ø ml/Tag",
        ...
        "delete_measurement_day": "Messtag löschen?", "delete_day_detail": "Alle Urin-, Wasser- und Hinweis-Einträge dieses Messtags werden aus Auswertung und Export entfernt.",
    ...
    .en: [
        ...
        "cancel": "Cancel", "entry_delete_confirm": "Delete this entry? It will be removed from analysis and exports.", "entries_day": "Entries for this day",
        "no_entries_day": "There are no entries for this day yet.", "edit": "Edit", "all_years": "All years",
        "all_months": "All months", "all_types": "All types", "filter_entries": "Filter entries", "search_entries": "Search entries", "clear_filters": "Clear filters", "measurement_days": "Days", "urine_total": "Urine total ml", "urine_average": "Urine avg ml/day",
        ...
        "delete_measurement_day": "Delete measurement day?", "delete_day_detail": "All urine, water and note entries for this day will be removed from analysis and exports.",
